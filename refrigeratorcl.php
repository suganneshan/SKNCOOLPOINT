    ...
    <nav class="navbar navbar-expand-lg  navbar-light  header-nav" id="navbar">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="refrigeratorcl.php">Refrigerator Service</a>
          </li>
          <li class="nav-item">
  ...
  <div class="tab-content">
   ...
   <div class="row text-center  justify-content-center mt-2 mb-2">
    ...
    <div class="card-body">
          ...
          $sql ="SELECT count(id) As total FROM rform WHERE r_service = 'Refrigeratior service' AND r_status = 'new'";;
...
<?php
        ...
        $query = "SELECT * FROM rform WHERE r_service = 'Refrigeratior service' AND r_status ='new'  ";
...
<div id="working" class="container tab-pane fade"><br>
   ...
   <section class="container">                  
           ...
           <div class="col-sm-12 col-md-6  col-lg-4 col-xl-4 ">  
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $sql ="SELECT count(id) As total FROM rform WHERE r_service = 'Refrigeratior service' AND r_status = 'working'";;
                  $result=mysqli_query($con,$sql);
                  $values=mysqli_fetch_assoc($result);
                  $num_rows=$values['total'];
        ...
        <?php
                ...
                $query = "SELECT * FROM rform WHERE r_service = 'Refrigeratior service' AND r_status ='working'  ";
                $query_run = mysqli_query($connection,$query);
        ?>
        <table class="table table-striped table-hover ">
    ...
    <section class="container">                  
           ...
           <div class="col-sm-12 col-md-6  col-lg-4 col-xl-4 ">  
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $sql ="SELECT count(id) As total FROM rform WHERE r_service = 'Refrigeratior service' AND r_status = 'close'";;
                  $result=mysqli_query($con,$sql);
                  $values=mysqli_fetch_assoc($result);
                  $num_rows=$values['total'];
        ...
        <?php
                ...
                $query = "SELECT * FROM rform WHERE r_service = 'Refrigeratior service' AND r_status ='close'  ";
                $query_run = mysqli_query($connection,$query);
        ?>
        <table class="table table-striped table-hover ">
...
<div id="pending" class="container tab-pane fade"><br>
      ...
      <section class="container">                  
             ...
             <div class="col-sm-12 col-md-6  col-lg-4 col-xl-4 ">  
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    $sql ="SELECT count(id) As total FROM rform WHERE r_service = 'Refrigeratior service' AND r_status = 'pending'";;
                    $result=mysqli_query($con,$sql);
                    $values=mysqli_fetch_assoc($result);
                    $num_rows=$values['total'];
          ...
          <?php
                  ...
                  $query = "SELECT * FROM rform WHERE r_service = 'Refrigeratior service' AND r_status ='pending'  ";
                  $query_run = mysqli_query($connection,$query);
          ?>
          <table class="table table-striped table-hover ">
  ...
  <!-- ############################### tab 5 ########################################-->
    ...
    <section class="container">                  
           ...
           <div class="col-sm-12 col-md-6  col-lg-4 col-xl-4 ">  
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $sql ="SELECT count(id) As total FROM rform WHERE r_service = 'Refrigeratior service' AND r_status = 'cancel'";;
                  $result=mysqli_query($con,$sql);
                  $values=mysqli_fetch_assoc($result);
                  $num_rows=$values['total'];
        ...
        <?php
                ...
                $query = "SELECT * FROM rform WHERE r_service = 'Refrigeratior service' AND r_status ='cancel'  ";
                $query_run = mysqli_query($connection,$query);
        ?>
        <table class="table table-striped table-hover ">
...
<!-- deletemodal -->
       <section class="modaled">
        <div class="modal fade" id="pendingrModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form  action="pendingr.php"  method="POST">
                  <div class="form_fild">
                     ...
                     <label for="">Location</label>
                      ...
                      <div class="input_group">
                        <input type="submit" name="pendingrdata"   class="btn btn-danger btn-block" value="UPDATE STATUS" />
                       </div>
    ...
    <!-- deletemodal -->
        ...
        <!-- footer -->
          ...
          $(document).ready(function(){
            $('.pendingrbtn').on('click',function(){

              $('#pendingrModal').modal('show');
